...
<Warning>
  During this step you do NOT have to download anything - if there are any popups JUST CLOSE THEM! - on work.ink you can just skip the download tasks and move on.
</Warning>

<img height="450" width="450" src="/images/keysys2.png" />

1. After clicking 'Get Access' click the "Get New Key".
...
1. Now you have your key - copy this key since you will need it for the next step.

<img height="450" width="450" src="/images/keysys4.png" />

1. Now you copy the key and paste it into the placeholder

<img height="450" width="450" src="/images/keysys5.png" />

1. When you placed your key - click the "Check Key" button\`.
